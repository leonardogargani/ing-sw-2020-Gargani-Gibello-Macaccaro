...
public class ConditionOnSwapDecorator implements MoveBehavior {
    ...
    public void handleMove(GameSession gameSession, Player player, Worker workerToMove, Coord newPosition) throws WinnerCaughtException {
        ...
        if (!cellOfOpponent.getOccupiedByDome() && !cellOfOpponent.getOccupiedByWorker())
            ...
            CellsHandler.AbstractIterator iterator = gameSession.getCellsHandler().directionIterator(workerToMove.getCurrentPosition(), newPosition);
