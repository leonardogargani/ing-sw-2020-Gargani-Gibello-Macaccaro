...
import it.polimi.ingsw.PSP43.server.gameStates.ChooseCardState;
...
public class DoubleDifferentSpaceBehaviourTest {
    ...
    public void handleBuildBlock() throws IOException, InterruptedException, GameEndedException, ClassNotFoundException {
        ...
        int[] workers = currentPlayer.getWorkersIdsArray();
        ...
        currentPlayer.getAbstractGodCard().buildBlock(new DataToAction(spyGame, currentPlayer, workerToCheck, firstBuild));
