...
public class AbstractGodCardTest {
    ...
    @Test
    public void moveTest() throws ClassNotFoundException, WinnerCaughtException, InterruptedException, IOException {
    ...
    @Test
    public void buildTest() throws InterruptedException, IOException, ClassNotFoundException {
    ...
    @Test
    public void findAvailablePositionsToBuildBlockTest() throws IOException {
    ...
    @Test
    public void findAvailablePositionsToBuildDomeTest() throws IOException {
        CellsHandler cellsHandler = spyGame.getCellsHandler();
